...
public class Reviews {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int numFrags = 1000;
        Header colsToTally = HEADER.subset(new String[] {"Game", "Language"});
        //Program program = new SequentialProgram(dataset, tempDir, filtered, results, colsToTally, numFrags);
        Program program = new ConcurrentProgram(dataset, tempDir, filtered, results, colsToTally, numFrags);
        program.execute();
    }
